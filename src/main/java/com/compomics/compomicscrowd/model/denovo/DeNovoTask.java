...
import com.compomics.compomicscrowd.control.connect.CompomicsScreenSaverResultConsumer;
...
public class DeNovoTask {
    ...
    public List<String> constructArguments() throws IOException, UnspecifiedPladipusException {
        File deNovoGUIJar = ScreenSaverProperties.getInstance().getDeNovoGUIJar();
     ...
     * found
     */
    public int run(ScreenSaverVisuals visuals) throws InterruptedException, UnspecifiedPladipusException {
        try {
