 ...
 */
package com.compomics.compomicscrowd;

import com.compomics.compomicscrowd.control.connect.CompomicsScreenSaverTaskConsumer;
import com.compomics.compomicscrowd.control.util.ScreenSaverProperties;
...
public class ScreenSaver extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        switch (mode) {
            case SCREEN_SAVER:
                ...
                break;
            case SETTINGS:
                ScreenSaverProperties instance = ScreenSaverProperties.getInstance();
    ...
    private static class TaskExecutor implements Runnable {
        ...
        private CompomicsScreenSaverTaskConsumer consumer = null;
        ...
        private void initConnections(boolean reset) {
            try {
                ...
                if (reset) {
                    ScreenSaverProperties.getInstance().reload();
                    CompomicsQueueConnectionFactory.reset(ScreenSaverProperties.getInstance());
                }
                CompomicsQueueConnectionFactory.getInstance(ScreenSaverProperties.getInstance());
                consumer = new CompomicsScreenSaverTaskConsumer(visuals);
                initialised = true;
