 ...
 */
package com.compomics.compomicscrowd.control.connect.actors;
...
public class DeNovoResultConsumer {
    ...
    public static void gatherResultFiles(File outputFolder) {
        while (true) {
            CompomicsScreenSaverResultConsumer consumer;
            try {
                consumer = new CompomicsScreenSaverResultConsumer(outputFolder);
                consumer.run();
