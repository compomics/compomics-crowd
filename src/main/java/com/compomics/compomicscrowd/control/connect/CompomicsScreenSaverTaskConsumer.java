 ...
 */
public class CompomicsScreenSaverTaskConsumer extends CompomicsSessionConsumer {

    /**
     * The logging instance
     */
    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(CompomicsScreenSaverTaskConsumer.class);
    /**
     * The json unmarshaller
     */
    private static final JsonMarshaller MARSHALLER = new IdentificationParametersMarshaller();
    /**
     * The used visuals (can be used to update messages on screen and keep users
     * updated in the future)
     */
    private final ScreenSaverVisuals visuals;

    public CompomicsScreenSaverTaskConsumer(ScreenSaverVisuals visuals) throws IOException, JMSException {
        ...
        if (message == null) {
            ...
            try {
                ...
                try {
                    ...
                    Logger.getLogger(CompomicsScreenSaverTaskConsumer.class.getName()).log(Level.SEVERE, null, ex1);
                }
            }
        } else {
