 ...
 */
public class ScreenSaverProperties extends NetworkProperties {

    /**
     * The Logger Instance
     */
    private static final Logger LOGGER = Logger.getLogger(ScreenSaverProperties.class);
    /**
     ...
     */
    public static ScreenSaverProperties getInstance() {
        if (instance == null) {
            instance = new ScreenSaverProperties();
            try {
            ...
            defaultPropFile = new File(configFolder, "screensaver.properties");
        ...
        return (ScreenSaverProperties) instance;
    }
    ...
    private static void copyFromResources() {
        ...
        if (defaultPropFile != null && !defaultPropFile.exists()) {
            ...
            try (OutputStream outputStream = new FileOutputStream(defaultPropFile); InputStream inputStream = new ClassPathResource("screensaver.properties").getInputStream()) {
